...
const createUserInfoRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'CreateUserInfo', inputVars);
}
createUserInfoRef.operationName = 'CreateUserInfo';
exports.createUserInfoRef = createUserInfoRef;

exports.createUserInfo = function createUserInfo(dcOrVars, vars) {
  return executeMutation(createUserInfoRef(dcOrVars, vars));
};

const updateUserInfoRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'UpdateUserInfo', inputVars);
}
updateUserInfoRef.operationName = 'UpdateUserInfo';
exports.updateUserInfoRef = updateUserInfoRef;

exports.updateUserInfo = function updateUserInfo(dcOrVars, vars) {
  return executeMutation(updateUserInfoRef(dcOrVars, vars));
};

const deleteUserInfoRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'DeleteUserInfo', inputVars);
}
deleteUserInfoRef.operationName = 'DeleteUserInfo';
exports.deleteUserInfoRef = deleteUserInfoRef;

exports.deleteUserInfo = function deleteUserInfo(dcOrVars, vars) {
...
const getUserInfoRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetUserInfo', inputVars);
}
getUserInfoRef.operationName = 'GetUserInfo';
exports.getUserInfoRef = getUserInfoRef;

exports.getUserInfo = function getUserInfo(dcOrVars, vars) {
